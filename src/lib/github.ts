 ...
 * 获取 FGateNexus 的版本信息
 */
export const getFGateNexusVersion = (): Promise<VersionInfo> =>
  getLatestVersion("CrashVibe", "FGateNexus")

/**
 * 获取 FGateClient 的版本信息
 */
export const getFGateClientVersion = (): Promise<VersionInfo> =>
  getLatestVersion("CrashVibe", "FGateClient")
